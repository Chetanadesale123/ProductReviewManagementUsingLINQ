...
class Program
{
    static void Main(String[] args)
    {
        ...
        reviewList.Add(new ProductReview() { ProductId = 7, UserId = 117, Rating = 3, Review = "Nice", IsLike = true });
        ...
        reviewList.Add(new ProductReview() { ProductId = 20, UserId = 130, Rating = 3, Review = "Nice", IsLike = true });
